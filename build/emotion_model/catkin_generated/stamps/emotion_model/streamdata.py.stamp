...
class RobotCameraEmotionDetector:
    def __init__(self):
        ...
        self.pub = rospy.Publisher('emotiondetect_result', String, queue_size=10)
    ...
    def image_callback(self, image_msg):
        ...
        if dets is not None and len(dets) > 0:
            ...
            detected_emotions = ", ".join(self.predictor.listemo[idx] for idx in pred_index)
            print(f"Detected emotions: {detected_emotions}")
            self.pub.publish(detected_emotions)
