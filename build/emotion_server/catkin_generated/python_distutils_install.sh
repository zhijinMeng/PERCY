...
echo_and_run cd "/home/robocupathome/workspace/eddy_code/src/emotion_server"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/robocupathome/workspace/eddy_code/src/emotion_server/setup.py" \
     \
    build --build-base "/home/robocupathome/workspace/eddy_code/build/emotion_server" \
    install \
    --root="${DESTDIR-/}" \
