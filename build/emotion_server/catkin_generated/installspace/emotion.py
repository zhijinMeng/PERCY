...
class emotion_recognizer:
    def __init__(self):
        ...
        self.service = rospy.Service('get_emotion', String, self.OnRequest)

        rospy.loginfo('Emotion Server node started')
        
        pass

    def get_emotion(self, one_path_mp4, one_path_wav, one_path_text):
        result_str = get_predict_result(one_path_mp4, one_path_wav, one_path_text, tokenizer, model_load)
        return result_str
    
    def OnRequest(self, data: String):
        
        return self.get_emotion(one_path_mp4, one_path_wav, one_path_text)
