...
if("TRUE" STREQUAL "TRUE")
  set(gridmap_2d_SOURCE_PREFIX /home/zhijin/pt0/src/humanoid_navigation/gridmap_2d)
  set(gridmap_2d_DEVEL_PREFIX /home/zhijin/pt0/devel)
  ...
  set(gridmap_2d_INSTALL_PREFIX /home/zhijin/pt0/install)
...
if(NOT "/home/zhijin/pt0/src/humanoid_navigation/gridmap_2d/include;/usr/include/opencv4 " STREQUAL " ")
  set(gridmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhijin/pt0/src/humanoid_navigation/gridmap_2d/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gridmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhijin/pt0/src/humanoid_navigation/gridmap_2d/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gridmap_2d_EXPORTED_TARGETS ${${gridmap_2d_dep}_EXPORTED_TARGETS})
endforeach()
