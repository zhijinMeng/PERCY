...
let FaceOverlayFeedback = require('./FaceOverlayFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class FaceOverlayActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FaceOverlayFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FaceOverlayFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FaceOverlayActionFeedback(null);
    ...
    data.feedback = FaceOverlayFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceOverlayActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FaceOverlayFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FaceOverlayFeedback()
    }
...
module.exports = FaceOverlayActionFeedback;
