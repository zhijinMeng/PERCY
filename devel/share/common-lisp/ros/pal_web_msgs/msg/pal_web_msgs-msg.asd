...
(defsystem "pal_web_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "Subtitles" :depends-on ("_package_Subtitles"))
    (:file "_package_Subtitles" :depends-on ("_package"))
    (:file "TouchWeb" :depends-on ("_package_TouchWeb"))
    (:file "_package_TouchWeb" :depends-on ("_package"))
