...
(cl:in-package attention_manager-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetPolicy-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPolicy-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name attention_manager-srv:<SetPolicy-request> is deprecated: use attention_manager-srv:SetPolicy-request instead.")))

(cl:ensure-generic-function 'policy-val :lambda-list '(m))
(cl:defmethod policy-val ((m <SetPolicy-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader attention_manager-srv:policy-val is deprecated.  Use attention_manager-srv:policy instead.")
  (policy m))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <SetPolicy-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader attention_manager-srv:frame-val is deprecated.  Use attention_manager-srv:frame instead.")
  (frame m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPolicy-request>)))
  ...
  "attention_manager/SetPolicyRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPolicy-request)))
  "Returns string type for a service object of type 'SetPolicy-request"
  "attention_manager/SetPolicyRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPolicy-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPolicy-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name attention_manager-srv:<SetPolicy-response> is deprecated: use attention_manager-srv:SetPolicy-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetPolicy-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader attention_manager-srv:success-val is deprecated.  Use attention_manager-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'error_msg-val :lambda-list '(m))
(cl:defmethod error_msg-val ((m <SetPolicy-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader attention_manager-srv:error_msg-val is deprecated.  Use attention_manager-srv:error_msg instead.")
  (error_msg m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPolicy-response>)))
  ...
  "attention_manager/SetPolicyResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPolicy-response)))
  "Returns string type for a service object of type 'SetPolicy-response"
  "attention_manager/SetPolicyResponse")
