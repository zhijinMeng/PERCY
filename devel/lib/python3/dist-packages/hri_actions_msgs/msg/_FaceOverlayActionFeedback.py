...
"""autogenerated by genpy from hri_actions_msgs/FaceOverlayActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class FaceOverlayActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "hri_actions_msgs/FaceOverlayActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hri_actions_msgs/FaceOverlayFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceOverlayActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hri_actions_msgs.msg.FaceOverlayFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hri_actions_msgs.msg.FaceOverlayFeedback()
