...
"""autogenerated by genpy from hri_actions_msgs/PointTrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class PointTrajectoryActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hri_actions_msgs/PointTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hri_actions_msgs/PointTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hri_actions_msgs.msg.PointTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hri_actions_msgs.msg.PointTrajectoryResult()
