...
"""autogenerated by genpy from hri_actions_msgs/FaceOverlayActionResult.msg. Do not edit."""
import codecs
import sys
...
class FaceOverlayActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "hri_actions_msgs/FaceOverlayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hri_actions_msgs/FaceOverlayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceOverlayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hri_actions_msgs.msg.FaceOverlayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hri_actions_msgs.msg.FaceOverlayResult()
