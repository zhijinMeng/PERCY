...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef TOUCH_PAGE
#endif
#if defined(_WIN32) && defined(TOUCH_PROJECT)
  #undef TOUCH_PROJECT
#endif
...
struct MD5Sum< ::pal_web_msgs::WebGoTo_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xebc2a9485f94d071ULL;
  static const uint64_t static_value2 = 0xd9e91bff52b88c08ULL;
};
